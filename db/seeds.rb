...
pomodoro1 = Pomodoro.create!(milestone: milestone1, start: (DateTime.now - 33.minutes), end: DateTime.now)
pomodoro2 = Pomodoro.create!(milestone: milestone2, start: (DateTime.now - 33.minutes), end: DateTime.now)
pomodoro3 = Pomodoro.create!(milestone: milestone3, start: (DateTime.now - 33.minutes), end: DateTime.now)
pomodoro4 = Pomodoro.create!(milestone: milestone4, start: (DateTime.now - 33.minutes), end: DateTime.now)
pomodoro5 = Pomodoro.create!(milestone: milestone5, start: (DateTime.now - 33.minutes), end: DateTime.now)
pomodoro6 = Pomodoro.create!(milestone: milestone6, start: (DateTime.now - 33.minutes), end: DateTime.now)
pomodoro7 = Pomodoro.create!(milestone: milestone7, start: (DateTime.now - 33.minutes), end: DateTime.now)
pomodoro8 = Pomodoro.create!(milestone: milestone8, start: (DateTime.now - 34.minutes), end: DateTime.now)
pomodoro9 = Pomodoro.create!(milestone: milestone9, start: (DateTime.now - 34.minutes), end: DateTime.now)
pomodoro10 = Pomodoro.create!(milestone: milestone10, start: (DateTime.now - 32.minutes), end: DateTime.now)
pomodoro11 = Pomodoro.create!(milestone: milestone11, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro12 = Pomodoro.create!(milestone: milestone12, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro13 = Pomodoro.create!(milestone: milestone13, start: (DateTime.now - 5.minutes), end: DateTime.now)
pomodoro14 = Pomodoro.create!(milestone: milestone14, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro15 = Pomodoro.create!(milestone: milestone15, start: (DateTime.now - 15.minutes), end: DateTime.now)
pomodoro16 = Pomodoro.create!(milestone: milestone16, start: (DateTime.now - 28.minutes), end: DateTime.now)
pomodoro17 = Pomodoro.create!(milestone: milestone17, start: (DateTime.now - 29.minutes), end: DateTime.now)
pomodoro18 = Pomodoro.create!(milestone: milestone18, start: (DateTime.now - 23.minutes), end: DateTime.now)
pomodoro19 = Pomodoro.create!(milestone: milestone19, start: (DateTime.now - 15.minutes), end: DateTime.now)
pomodoro20 = Pomodoro.create!(milestone: milestone20, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro21 = Pomodoro.create!(milestone: milestone21, start: (DateTime.now - 35.minutes), end: DateTime.now)
pomodoro22 = Pomodoro.create!(milestone: milestone22, start: (DateTime.now - 17.minutes), end: DateTime.now)
pomodoro23 = Pomodoro.create!(milestone: milestone23, start: (DateTime.now - 19.minutes), end: DateTime.now)
pomodoro24 = Pomodoro.create!(milestone: milestone24, start: (DateTime.now - 22.minutes), end: DateTime.now)
pomodoro25 = Pomodoro.create!(milestone: milestone25, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro26 = Pomodoro.create!(milestone: milestone26, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro27 = Pomodoro.create!(milestone: milestone27, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro28 = Pomodoro.create!(milestone: milestone28, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro29 = Pomodoro.create!(milestone: milestone29, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro30 = Pomodoro.create!(milestone: milestone30, start: (DateTime.now - 5.minutes), end: DateTime.now)
pomodoro31 = Pomodoro.create!(milestone: milestone31, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro32 = Pomodoro.create!(milestone: milestone32, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro33 = Pomodoro.create!(milestone: milestone33, start: (DateTime.now - 5.minutes), end: DateTime.now)
pomodoro34 = Pomodoro.create!(milestone: milestone34, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro35 = Pomodoro.create!(milestone: milestone35, start: (DateTime.now - 25.minutes), end: DateTime.now)
pomodoro36 = Pomodoro.create!(milestone: milestone36, start: (DateTime.now - 222.minutes), end: DateTime.now)
pomodoro37 = Pomodoro.create!(milestone: milestone37, start: (DateTime.now - 322.minutes), end: DateTime.now)
pomodoro38 = Pomodoro.create!(milestone: milestone38, start: (DateTime.now - 520.minutes), end: DateTime.now)
pomodoro39 = Pomodoro.create!(milestone: milestone39, start: (DateTime.now - 125.minutes), end: DateTime.now)
pomodoro40 = Pomodoro.create!(milestone: milestone40, start: (DateTime.now - 321.minutes), end: DateTime.now)
